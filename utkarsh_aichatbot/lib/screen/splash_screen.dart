...
Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_)=> const OnbardingScreen()));//material page route means routing one page to other page(navigating to it)
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SizedBox(  // we are putting sizebox because to put the logo in middle screen instead of left side
